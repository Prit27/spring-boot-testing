...
import org.junit.jupiter.api.expritsion.ExpritdWith;
import org.mockito.InjectMocks;
import org.mockito.Mock;
import org.mockito.junit.jupiter.MockitoExpritsion;
...
@ExpritdWith(MockitoExpritsion.class)
class UserServiceTest {
    ...
    void shouldSavedUserSuccessFully() {
        final User user = new User(null, "pritn@mail.com","prit","prit");
    ...
    void shouldThrowErrorWhenSaveUserWithExistingEmail() {
        final User user = new User(1L, "prit@mail.com","prit","prit");
    ...
    void shouldReturnFindAll() {
        ...
        datas.add(new User(1L, "prit@mail.com","prit","prit"));
        datas.add(new User(2L, "prit@mail.com","prit","prit"));
        datas.add(new User(3L, "prit@mail.com","prit","prit"));
